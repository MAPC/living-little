...
const GridItem = ({ typology }) => {
  ...
  const imageCredit = {
    ...
    cottage: <p>Photo Credit: Union Studio (Architect) and Nat Rea (photographer)</p>,
    tinyhouse: <p>Photo Credit: Alexis Smith<br/>Location: Burlington, VT</p>,
    townhouse: <p>Photo Credit: <a href="https://www.pexels.com/photo/house-architecture-home-modern-4044800/">Curtis Adams</a></p>,
    sfc: <p>Photo Credit: <a href="https://www.flickr.com/photos/24736216@N07/4264231167/">Roger W</a><br/>Location: Rockford, Illinois</p>,
    mixeduse: <p>Photo Credit: Nat Rea (photographer)<br/>Location: Union Studio - Capitol Square</p>,
    cohousing: <p>Photo Credit: <a href="https://www.flickr.com/photos/altopower/494359227/">Anne</a><br/>Location: Hearthstone Cohousing</p>,
  }
  const toggleClasses = () => {
